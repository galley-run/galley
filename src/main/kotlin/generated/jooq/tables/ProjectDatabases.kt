...
import generated.jooq.indexes.IDX_DB_CHARTER
import generated.jooq.indexes.IDX_DB_ENGINE_PLAN
import generated.jooq.indexes.IDX_DB_PROJECT
import generated.jooq.indexes.IDX_DB_VESSEL
import generated.jooq.keys.PROJECT_DATABASES_PKEY
...
open class ProjectDatabases(
   ...
   */
  val ID: TableField<ProjectDatabasesRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val VESSEL_ID: TableField<ProjectDatabasesRecord, UUID?> =
   ...
   */
  val CHARTER_ID: TableField<ProjectDatabasesRecord, UUID?> =
   ...
   */
  val PROJECT_ID: TableField<ProjectDatabasesRecord, UUID?> =
   ...
   */
  val CREATED_AT: TableField<ProjectDatabasesRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
   ...
   */
  val DELETED_AT: TableField<ProjectDatabasesRecord, OffsetDateTime?> =
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, ProjectDatabasesRecord>?, parentPath: InverseForeignKey<out Record, ProjectDatabasesRecord>?) : this(
   ...
   */
  open class ProjectDatabasesPath :
    ProjectDatabases,
    Path<ProjectDatabasesRecord> {
    constructor(
      path: Table<out Record>,
      childPath: ForeignKey<out Record, ProjectDatabasesRecord>?,
      parentPath: InverseForeignKey<out Record, ProjectDatabasesRecord>?,
  ...
  override fun getReferences(): List<ForeignKey<ProjectDatabasesRecord, *>> =
    listOf(PROJECT_DATABASES__FK_DB_CHARTER, PROJECT_DATABASES__FK_DB_PROJECT, PROJECT_DATABASES__FK_DB_VESSEL)
  ...
  ): ProjectDatabases = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): ProjectDatabases = where(DSL.condition(condition, *binds))
  ...
  ): ProjectDatabases = where(DSL.condition(condition, *parts))
