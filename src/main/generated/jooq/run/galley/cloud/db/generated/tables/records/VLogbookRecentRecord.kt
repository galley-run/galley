 ...
 */
@Suppress("warnings")
open class VLogbookRecentRecord() : TableRecordImpl<VLogbookRecentRecord>(VLogbookRecent.V_LOGBOOK_RECENT) {
    ...
    /**
     * Create a detached, initialised VLogbookRecentRecord
     */
     ...
     * Create a detached, initialised VLogbookRecentRecord
     */
    constructor(value: run.galley.cloud.db.generated.tables.pojos.VLogbookRecent?): this() {
        if (value != null) {
            this.id = value.id
