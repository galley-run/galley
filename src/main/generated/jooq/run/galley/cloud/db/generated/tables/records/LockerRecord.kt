...
open class LockerRecord() : UpdatableRecordImpl<LockerRecord>(Locker.LOCKER) {
     ...
     */
    constructor(id: UUID? = null, vesselId: UUID? = null, crewId: UUID? = null, name: String? = null, vaultMount: String? = null, vaultPath: String? = null, kvVersion: Int? = null, keyId: String? = null, fingerprint: String? = null, createdAt: OffsetDateTime? = null, updatedAt: OffsetDateTime? = null, expiresAt: OffsetDateTime? = null): this() {
        this.id = id
     ...
     * Create a detached, initialised LockerRecord
     */
    constructor(value: run.galley.cloud.db.generated.tables.pojos.Locker?): this() {
        if (value != null) {
            this.id = value.id
