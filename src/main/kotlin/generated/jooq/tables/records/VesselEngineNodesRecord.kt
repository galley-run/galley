...
open class VesselEngineNodesRecord() : UpdatableRecordImpl<VesselEngineNodesRecord>(VesselEngineNodes.VESSEL_ENGINE_NODES) {
  ...
  constructor(
    ...
    vesselEngineRegionId: UUID? = null,
    nodeType: NodeType? = null,
    deployMode: NodeDeployMode? = null,
    name: String? = null,
    ...
    provisioningLockerId: UUID? = null,
    provisioningSecurityUpdates: Boolean? = null,
    provisioningSecurityUpdatesSchedule: String? = null,
   ...
   * Create a detached, initialised VesselEngineNodesRecord
   */
  constructor(value: generated.jooq.tables.pojos.VesselEngineNodes?) : this() {
    if (value != null) {
      this.id = value.id
