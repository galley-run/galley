...
import generated.jooq.indexes.IDX_USERS_EMAIL_TRGM
...
import generated.jooq.tables.ApiKeys.ApiKeysPath
...
import generated.jooq.tables.WebauthnCredentials.WebauthnCredentialsPath
...
open class Users(
   ...
   */
  val ID: TableField<UsersRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val CREATED_AT: TableField<UsersRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, UsersRecord>?, parentPath: InverseForeignKey<out Record, UsersRecord>?) : this(
