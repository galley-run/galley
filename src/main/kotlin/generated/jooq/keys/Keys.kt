...
val PROJECT_APPLICATIONS__FK_APPLICATIONS_CHARTER_COMPUTE_PLAN: ForeignKey<ProjectApplicationsRecord, CharterComputePlansRecord> = Internal.createForeignKey(ProjectApplications.PROJECT_APPLICATIONS, DSL.name("fk_applications_charter_compute_plan"), arrayOf(ProjectApplications.PROJECT_APPLICATIONS.CHARTER_COMPUTE_PLAN_ID), generated.jooq.keys.CHARTER_COMPUTE_PLANS_PKEY, arrayOf(CharterComputePlans.CHARTER_COMPUTE_PLANS.ID), true, ForeignKeyRule.SET_NULL, ForeignKeyRule.NO_ACTION)
