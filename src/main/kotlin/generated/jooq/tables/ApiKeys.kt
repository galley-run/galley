...
import generated.jooq.indexes.IDX_API_KEYS_LAST_USED
import generated.jooq.indexes.IDX_API_KEYS_USER_STATUS
import generated.jooq.keys.API_KEYS_PKEY
import generated.jooq.keys.API_KEYS_PREFIX_KEY
import generated.jooq.keys.API_KEYS__FK_API_KEYS_USER
...
open class ApiKeys(
   ...
   */
  val ID: TableField<ApiKeysRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val STATUS: TableField<ApiKeysRecord, ApiKeyStatus?> =
    createField(
      DSL.name("status"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(DSL.field(DSL.raw("'active'::api_key_status"), SQLDataType.VARCHAR))
        .asEnumDataType(ApiKeyStatus::class.java),
      this,
      "",
    )
   ...
   */
  val LAST_USED_AT: TableField<ApiKeysRecord, OffsetDateTime?> =
   ...
   */
  val CREATED_AT: TableField<ApiKeysRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, ApiKeysRecord>?, parentPath: InverseForeignKey<out Record, ApiKeysRecord>?) : this(
  ...
  ): ApiKeys = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): ApiKeys = where(DSL.condition(condition, *binds))
  ...
  ): ApiKeys = where(DSL.condition(condition, *parts))
