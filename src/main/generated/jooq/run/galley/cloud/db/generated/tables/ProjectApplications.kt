...
import run.galley.cloud.db.generated.indexes.IDX_APP_CHARTER
import run.galley.cloud.db.generated.indexes.IDX_APP_DELETED
import run.galley.cloud.db.generated.indexes.IDX_APP_PROJECT
import run.galley.cloud.db.generated.indexes.IDX_APP_VESSEL
import run.galley.cloud.db.generated.keys.PROJECT_APPLICATIONS_PKEY
import run.galley.cloud.db.generated.keys.PROJECT_APPLICATIONS__FK_APP_CHARTER
import run.galley.cloud.db.generated.keys.PROJECT_APPLICATIONS__FK_APP_PROJECT
import run.galley.cloud.db.generated.keys.PROJECT_APPLICATIONS__FK_APP_VESSEL
import run.galley.cloud.db.generated.keys.UQ_PROJECT_SLUG
...
open class ProjectApplications(
     ...
     */
    val ID: TableField<ProjectApplicationsRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")

    /**
     * The column <code>public.project_applications.vessel_id</code>.
     */
    val VESSEL_ID: TableField<ProjectApplicationsRecord, UUID?> = createField(DSL.name("vessel_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.project_applications.charter_id</code>.
     */
    val CHARTER_ID: TableField<ProjectApplicationsRecord, UUID?> = createField(DSL.name("charter_id"), SQLDataType.UUID.nullable(false), this, "")

    /**
     * The column <code>public.project_applications.project_id</code>.
     */
    val PROJECT_ID: TableField<ProjectApplicationsRecord, UUID?> = createField(DSL.name("project_id"), SQLDataType.UUID.nullable(false), this, "")
     ...
     */
    val CREATED_AT: TableField<ProjectApplicationsRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, ProjectApplicationsRecord>?, parentPath: InverseForeignKey<out Record, ProjectApplicationsRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, PROJECT_APPLICATIONS, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class ProjectApplicationsPath : ProjectApplications, Path<ProjectApplicationsRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, ProjectApplicationsRecord>?, parentPath: InverseForeignKey<out Record, ProjectApplicationsRecord>?): super(path, childPath, parentPath)
     ...
     */
    override fun where(condition: Condition?): ProjectApplications = ProjectApplications(qualifiedName, if (aliased()) this else null, condition)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): ProjectApplications = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): ProjectApplications = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): ProjectApplications = where(DSL.condition(condition, *parts))
