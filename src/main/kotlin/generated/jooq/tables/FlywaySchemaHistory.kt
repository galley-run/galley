...
import generated.jooq.indexes.FLYWAY_SCHEMA_HISTORY_S_IDX
import generated.jooq.keys.FLYWAY_SCHEMA_HISTORY_PK
...
open class FlywaySchemaHistory(
   ...
   */
  val INSTALLED_RANK: TableField<FlywaySchemaHistoryRecord, Int?> =
   ...
   */
  val DESCRIPTION: TableField<FlywaySchemaHistoryRecord, String?> =
   ...
   */
  val SCRIPT: TableField<FlywaySchemaHistoryRecord, String?> =
   ...
   */
  val INSTALLED_BY: TableField<FlywaySchemaHistoryRecord, String?> =
   ...
   */
  val INSTALLED_ON: TableField<FlywaySchemaHistoryRecord, LocalDateTime?> =
    createField(
   ...
   */
  val EXECUTION_TIME: TableField<FlywaySchemaHistoryRecord, Int?> =
   ...
   */
  override fun where(condition: Condition?): FlywaySchemaHistory =
    FlywaySchemaHistory(qualifiedName, if (aliased()) this else null, condition)
  ...
  ): FlywaySchemaHistory = where(DSL.condition(condition, *parts))
