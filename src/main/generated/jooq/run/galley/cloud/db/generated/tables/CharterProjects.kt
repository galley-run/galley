...
import run.galley.cloud.db.generated.indexes.IDX_PROJECTS_CHARTER
import run.galley.cloud.db.generated.indexes.IDX_PROJECTS_CHARTER_DELETED
import run.galley.cloud.db.generated.indexes.UQ_PROJECTS_NAME_ENV
import run.galley.cloud.db.generated.keys.CHARTER_PROJECTS_PKEY
...
open class CharterProjects(
     ...
     */
    val ID: TableField<CharterProjectsRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")
     ...
     */
    val ENVIRONMENT: TableField<CharterProjectsRecord, String?> = createField(DSL.name("environment"), SQLDataType.CLOB.nullable(false).defaultValue(DSL.field(DSL.raw("'production'::text"), SQLDataType.CLOB)), this, "")
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, CharterProjectsRecord>?, parentPath: InverseForeignKey<out Record, CharterProjectsRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, CHARTER_PROJECTS, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class CharterProjectsPath : CharterProjects, Path<CharterProjectsRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, CharterProjectsRecord>?, parentPath: InverseForeignKey<out Record, CharterProjectsRecord>?): super(path, childPath, parentPath)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): CharterProjects = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): CharterProjects = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): CharterProjects = where(DSL.condition(condition, *parts))
