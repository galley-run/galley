...
import generated.jooq.indexes.IDX_CREW_ACTIVE
import generated.jooq.indexes.IDX_CREW_STATUS
import generated.jooq.indexes.IDX_CREW_USER
import generated.jooq.indexes.IDX_CREW_VESSEL
import generated.jooq.keys.CREW_CHARTER_MEMBER__FK_CCM_CREW
import generated.jooq.keys.CREW_PKEY
...
import generated.jooq.keys.UQ_CREW_USER_VESSEL
...
open class Crew(
   ...
   */
  val ID: TableField<CrewRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val VESSEL_ROLE: TableField<CrewRecord, VesselRole?> =
    createField(
      DSL.name("vessel_role"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(DSL.field(DSL.raw("'captain'::vessel_role"), SQLDataType.VARCHAR))
        .asEnumDataType(VesselRole::class.java),
      this,
      "",
    )
   ...
   */
  val STATUS: TableField<CrewRecord, MemberStatus?> =
    createField(
      DSL.name("status"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(DSL.field(DSL.raw("'invited'::member_status"), SQLDataType.VARCHAR))
        .asEnumDataType(MemberStatus::class.java),
      this,
      "",
    )
   ...
   */
  val CREATED_AT: TableField<CrewRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
   ...
   */
  val ACTIVATED_AT: TableField<CrewRecord, OffsetDateTime?> =
    createField(DSL.name("activated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")

  /**
   * The column <code>public.crew.deleted_at</code>.
   */
  val DELETED_AT: TableField<CrewRecord, OffsetDateTime?> =
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, CrewRecord>?, parentPath: InverseForeignKey<out Record, CrewRecord>?) : this(
  ...
  ): Crew = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): Crew = where(DSL.condition(condition, *binds))
  ...
  ): Crew = where(DSL.condition(condition, *parts))
