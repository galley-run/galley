...
open class ProjectDatabasesRecord() : UpdatableRecordImpl<ProjectDatabasesRecord>(ProjectDatabases.PROJECT_DATABASES) {
     ...
     */
    constructor(id: UUID? = null, vesselId: UUID? = null, charterId: UUID? = null, projectId: UUID? = null, engine: String? = null, plan: String? = null, createdAt: OffsetDateTime? = null, deletedAt: OffsetDateTime? = null): this() {
        this.id = id
     ...
     * Create a detached, initialised ProjectDatabasesRecord
     */
    constructor(value: run.galley.cloud.db.generated.tables.pojos.ProjectDatabases?): this() {
        if (value != null) {
            this.id = value.id
