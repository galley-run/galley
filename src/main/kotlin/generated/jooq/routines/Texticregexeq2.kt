 ...
 */
@Suppress("warnings")
open class Texticregexeq2 : AbstractRoutine<Boolean>("texticregexeq", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
    ...
    init {
        returnParameter = Texticregexeq2.RETURN_VALUE
        addInParameter(Texticregexeq2._1)
        addInParameter(Texticregexeq2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Texticregexeq2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Texticregexeq2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Texticregexeq2._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(Texticregexeq2._2, field)
    }
}
