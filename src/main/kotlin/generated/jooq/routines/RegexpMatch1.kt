 ...
 */
@Suppress("warnings")
open class RegexpMatch1 : AbstractRoutine<Array<String?>>("regexp_match", Public.PUBLIC, DSL.comment(""), SQLDataType.CLOB.array()) {
    companion object {
    ...
    init {
        returnParameter = RegexpMatch1.RETURN_VALUE
        addInParameter(RegexpMatch1._1)
        addInParameter(RegexpMatch1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(RegexpMatch1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(RegexpMatch1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(RegexpMatch1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(RegexpMatch1._2, field)
    }
}
