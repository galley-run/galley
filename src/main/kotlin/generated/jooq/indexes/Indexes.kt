...
val IDX_NODES_OS_METADATA_GIN: Index = Internal.createIndex(DSL.name("idx_nodes_os_metadata_gin"), VesselEngineNodes.VESSEL_ENGINE_NODES, arrayOf(VesselEngineNodes.VESSEL_ENGINE_NODES.OS_METADATA), false)
val IDX_NODES_PROVISIONING_STATUS: Index = Internal.createIndex(DSL.name("idx_nodes_provisioning_status"), VesselEngineNodes.VESSEL_ENGINE_NODES, arrayOf(VesselEngineNodes.VESSEL_ENGINE_NODES.PROVISIONING_STATUS), false)
...
val IDX_VESSEL_ENGINES_LAST_CONNECTION_AT: Index = Internal.createIndex(DSL.name("idx_vessel_engines_last_connection_at"), VesselEngines.VESSEL_ENGINES, arrayOf(VesselEngines.VESSEL_ENGINES.LAST_AGENT_CONNECTION_AT), false)
...
val UQ_COMPUTE_PLANS_CHARTER_NAME: Index = Internal.createIndex(DSL.name("uq_compute_plans_charter_name"), CharterComputePlans.CHARTER_COMPUTE_PLANS, arrayOf(CharterComputePlans.CHARTER_COMPUTE_PLANS.CHARTER_ID, CharterComputePlans.CHARTER_COMPUTE_PLANS.NAME), true)
...
val UQ_NODES_ENGINE_IP: Index = Internal.createIndex(DSL.name("uq_nodes_engine_ip"), VesselEngineNodes.VESSEL_ENGINE_NODES, arrayOf(VesselEngineNodes.VESSEL_ENGINE_NODES.VESSEL_ENGINE_ID, VesselEngineNodes.VESSEL_ENGINE_NODES.IP_ADDRESS), true)
