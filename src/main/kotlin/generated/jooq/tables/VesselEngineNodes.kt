...
open class VesselEngineNodes(
   ...
   */
  val ID: TableField<VesselEngineNodesRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val VESSEL_ID: TableField<VesselEngineNodesRecord, UUID?> =
   ...
   */
  val VESSEL_ENGINE_ID: TableField<VesselEngineNodesRecord, UUID?> =
   ...
   */
  val VESSEL_ENGINE_REGION_ID: TableField<VesselEngineNodesRecord, UUID?> =
    createField(DSL.name("vessel_engine_region_id"), SQLDataType.UUID.nullable(false), this, "")

  /**
   * The column <code>public.vessel_engine_nodes.node_type</code>.
   */
  val NODE_TYPE: TableField<VesselEngineNodesRecord, NodeType?> =
    createField(
      DSL.name("node_type"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(DSL.field(DSL.raw("'controller'::node_type"), SQLDataType.VARCHAR))
        .asEnumDataType(NodeType::class.java),
      this,
      "",
    )
   ...
   */
  val DEPLOY_MODE: TableField<VesselEngineNodesRecord, NodeDeployMode?> =
    createField(
      DSL.name("deploy_mode"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(
          DSL.field(DSL.raw("'applications_databases'::node_deploy_mode"), SQLDataType.VARCHAR),
        ).asEnumDataType(NodeDeployMode::class.java),
      this,
      "",
    )
   ...
   */
  val IP_ADDRESS: TableField<VesselEngineNodesRecord, String?> =
   ...
   */
  val PROVISIONING: TableField<VesselEngineNodesRecord, Boolean?> =
    createField(
      DSL.name("provisioning"),
   ...
   */
  val PROVISIONING_LOCKER_ID: TableField<VesselEngineNodesRecord, UUID?> =
    createField(DSL.name("provisioning_locker_id"), SQLDataType.UUID, this, "")

  /**
   * The column
   * <code>public.vessel_engine_nodes.provisioning_security_updates</code>.
   */
  val PROVISIONING_SECURITY_UPDATES: TableField<VesselEngineNodesRecord, Boolean?> =
    createField(
      DSL.name("provisioning_security_updates"),
      SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)),
      this,
      "",
    )
   ...
   */
  val PROVISIONING_SECURITY_UPDATES_SCHEDULE: TableField<VesselEngineNodesRecord, String?> =
    createField(DSL.name("provisioning_security_updates_schedule"), SQLDataType.CLOB, this, "")

  /**
   * The column <code>public.vessel_engine_nodes.created_at</code>.
   */
  val CREATED_AT: TableField<VesselEngineNodesRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, VesselEngineNodesRecord>?, parentPath: InverseForeignKey<out Record, VesselEngineNodesRecord>?) : this(
   ...
   */
  open class VesselEngineNodesPath :
    VesselEngineNodes,
    Path<VesselEngineNodesRecord> {
    constructor(
      path: Table<out Record>,
      childPath: ForeignKey<out Record, VesselEngineNodesRecord>?,
      parentPath: InverseForeignKey<out Record, VesselEngineNodesRecord>?,
  ...
  override fun getIndexes(): List<Index> =
    listOf(IDX_NODES_ENGINE, IDX_NODES_PROVISIONING_TIME, IDX_NODES_REGION, IDX_NODES_TYPE_MODE, IDX_NODES_VESSEL, UQ_NODES_IP)

  override fun getPrimaryKey(): UniqueKey<VesselEngineNodesRecord> = VESSEL_ENGINE_NODES_PKEY

  override fun getReferences(): List<ForeignKey<VesselEngineNodesRecord, *>> =
    listOf(
      VESSEL_ENGINE_NODES__FK_NODES_ENGINE,
      VESSEL_ENGINE_NODES__FK_NODES_PROVISIONING_LOCKER,
      VESSEL_ENGINE_NODES__FK_NODES_REGION,
      VESSEL_ENGINE_NODES__FK_NODES_VESSEL,
    )
  ...
  ): VesselEngineNodes = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): VesselEngineNodes = where(DSL.condition(condition, *binds))
  ...
  ): VesselEngineNodes = where(DSL.condition(condition, *parts))
