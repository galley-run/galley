...
open class WebauthnCredentialsRecord() : UpdatableRecordImpl<WebauthnCredentialsRecord>(WebauthnCredentials.WEBAUTHN_CREDENTIALS) {
     ...
     */
    constructor(id: UUID? = null, userId: UUID? = null, credentialId: ByteArray? = null, publicKey: ByteArray? = null, aaguid: UUID? = null, signCount: Long? = null, transports: Array<String?>? = null, isDiscoverable: Boolean? = null, isBackupEligible: Boolean? = null, name: String? = null, lastUsedAt: OffsetDateTime? = null, createdAt: OffsetDateTime? = null): this() {
        this.id = id
        this.userId = userId
     ...
     * Create a detached, initialised WebauthnCredentialsRecord
     */
    constructor(value: run.galley.cloud.db.generated.tables.pojos.WebauthnCredentials?): this() {
        if (value != null) {
            this.id = value.id
