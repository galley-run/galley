...
import generated.jooq.indexes.IDX_OUTBOX_AGGREGATE_TIME
import generated.jooq.indexes.IDX_OUTBOX_CHARTER_TIME
import generated.jooq.indexes.IDX_OUTBOX_METADATA_GIN
import generated.jooq.indexes.IDX_OUTBOX_PAYLOAD_GIN
import generated.jooq.indexes.IDX_OUTBOX_PROJECT_TIME
import generated.jooq.indexes.IDX_OUTBOX_STATUS_NEXT
import generated.jooq.indexes.IDX_OUTBOX_TYPE_TIME
import generated.jooq.indexes.IDX_OUTBOX_VESSEL_TIME
import generated.jooq.keys.OUTBOX_EVENTS_PKEY
import generated.jooq.keys.OUTBOX_EVENTS__FK_OUTBOX_CHARTER
import generated.jooq.keys.OUTBOX_EVENTS__FK_OUTBOX_PROJECT
import generated.jooq.keys.OUTBOX_EVENTS__FK_OUTBOX_VESSEL
import generated.jooq.keys.UQ_OUTBOX_EVENT_KEY
...
open class OutboxEvents(
   ...
   */
  val ID: TableField<OutboxEventsRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val AGGREGATE_TABLE: TableField<OutboxEventsRecord, String?> =
    createField(DSL.name("aggregate_table"), SQLDataType.CLOB.nullable(false), this, "")
   ...
   */
  val EVENT_TYPE: TableField<OutboxEventsRecord, String?> =
    createField(DSL.name("event_type"), SQLDataType.CLOB.nullable(false), this, "")
   ...
   */
  val EVENT_VERSION: TableField<OutboxEventsRecord, Int?> =
    createField(
      DSL.name("event_version"),
   ...
   */
  val STATUS: TableField<OutboxEventsRecord, OutboxStatus?> =
    createField(
      DSL.name("status"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(DSL.field(DSL.raw("'pending'::outbox_status"), SQLDataType.VARCHAR))
        .asEnumDataType(OutboxStatus::class.java),
      this,
      "",
    )
   ...
   */
  val ATTEMPTS: TableField<OutboxEventsRecord, Int?> =
    createField(
      DSL.name("attempts"),
   ...
   */
  val NEXT_ATTEMPT_AT: TableField<OutboxEventsRecord, OffsetDateTime?> =
    createField(
   ...
   */
  val PROCESSED_AT: TableField<OutboxEventsRecord, OffsetDateTime?> =
    createField(DSL.name("processed_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")
   ...
   */
  val CREATED_AT: TableField<OutboxEventsRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
      SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)),
      this,
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, OutboxEventsRecord>?, parentPath: InverseForeignKey<out Record, OutboxEventsRecord>?) : this(
   ...
   */
  open class OutboxEventsPath :
    OutboxEvents,
    Path<OutboxEventsRecord> {
    constructor(
      path: Table<out Record>,
      childPath: ForeignKey<out Record, OutboxEventsRecord>?,
      parentPath: InverseForeignKey<out Record, OutboxEventsRecord>?,
  ...
  override fun getIndexes(): List<Index> =
    listOf(
      IDX_OUTBOX_AGGREGATE_TIME,
      IDX_OUTBOX_CHARTER_TIME,
      IDX_OUTBOX_METADATA_GIN,
      IDX_OUTBOX_PAYLOAD_GIN,
      IDX_OUTBOX_PROJECT_TIME,
      IDX_OUTBOX_STATUS_NEXT,
      IDX_OUTBOX_TYPE_TIME,
      IDX_OUTBOX_VESSEL_TIME,
    )
  ...
  override fun getReferences(): List<ForeignKey<OutboxEventsRecord, *>> =
    listOf(OUTBOX_EVENTS__FK_OUTBOX_CHARTER, OUTBOX_EVENTS__FK_OUTBOX_PROJECT, OUTBOX_EVENTS__FK_OUTBOX_VESSEL)
  ...
  ): OutboxEvents = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): OutboxEvents = where(DSL.condition(condition, *binds))
  ...
  ): OutboxEvents = where(DSL.condition(condition, *parts))
