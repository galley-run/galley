 ...
 */
@Suppress("warnings")
open class CitextCmp : AbstractRoutine<Int>("citext_cmp", Public.PUBLIC, DSL.comment(""), SQLDataType.INTEGER) {
    companion object {
    ...
    init {
        returnParameter = CitextCmp.RETURN_VALUE
        addInParameter(CitextCmp._1)
        addInParameter(CitextCmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: String?): Unit = setValue(CitextCmp._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(CitextCmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(CitextCmp._2, value)
