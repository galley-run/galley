...
import run.galley.cloud.db.generated.indexes.SESSIONS_EXPIRES_AT_IDX
import run.galley.cloud.db.generated.indexes.SESSIONS_REVOKED_AT_IDX
import run.galley.cloud.db.generated.indexes.SESSIONS_USER_ID_IDX
import run.galley.cloud.db.generated.keys.SESSIONS_PKEY
import run.galley.cloud.db.generated.keys.SESSIONS_USER_ID_REFRESH_TOKEN_HASH_KEY
import run.galley.cloud.db.generated.keys.SESSIONS__SESSIONS_REPLACED_BY_ID_FKEY
...
open class Sessions(
     ...
     */
    val ID: TableField<SessionsRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")
     ...
     */
    val IP_ADDRESS: TableField<SessionsRecord, Inet?> = createField(DSL.name("ip_address"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"inet\""), this, "", InetBinding())

    /**
     * The column <code>public.sessions.issued_at</code>.
     */
    val ISSUED_AT: TableField<SessionsRecord, OffsetDateTime?> = createField(DSL.name("issued_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.sessions.last_used_at</code>.
     */
    val LAST_USED_AT: TableField<SessionsRecord, OffsetDateTime?> = createField(DSL.name("last_used_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.sessions.expires_at</code>.
     */
    val EXPIRES_AT: TableField<SessionsRecord, OffsetDateTime?> = createField(DSL.name("expires_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")

    /**
     * The column <code>public.sessions.revoked_at</code>.
     */
    val REVOKED_AT: TableField<SessionsRecord, OffsetDateTime?> = createField(DSL.name("revoked_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")
    ...
    override fun getReferences(): List<ForeignKey<SessionsRecord, *>> = listOf(SESSIONS__SESSIONS_REPLACED_BY_ID_FKEY, SESSIONS__SESSIONS_USER_ID_FKEY)
