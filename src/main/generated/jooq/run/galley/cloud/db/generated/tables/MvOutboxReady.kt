...
import run.galley.cloud.db.generated.indexes.IDX_MV_OUTBOX_READY_NEXT
import run.galley.cloud.db.generated.tables.records.MvOutboxReadyRecord
...
open class MvOutboxReady(
     ...
     */
    val STATUS: TableField<MvOutboxReadyRecord, OutboxStatus?> = createField(DSL.name("status"), SQLDataType.VARCHAR.asEnumDataType(OutboxStatus::class.java), this, "")
     ...
     */
    val NEXT_ATTEMPT_AT: TableField<MvOutboxReadyRecord, OffsetDateTime?> = createField(DSL.name("next_attempt_at"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "")

    /**
     * The column <code>public.mv_outbox_ready.processed_at</code>.
     */
    val PROCESSED_AT: TableField<MvOutboxReadyRecord, OffsetDateTime?> = createField(DSL.name("processed_at"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "")
     ...
     */
    val CREATED_AT: TableField<MvOutboxReadyRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "")

    private constructor(alias: Name, aliased: Table<MvOutboxReadyRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<MvOutboxReadyRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<MvOutboxReadyRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): MvOutboxReady = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): MvOutboxReady = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): MvOutboxReady = where(DSL.condition(condition, *parts))
