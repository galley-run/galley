...
import run.galley.cloud.db.generated.indexes.IDX_WEBAUTHN_USER
import run.galley.cloud.db.generated.keys.WEBAUTHN_CREDENTIALS_CREDENTIAL_ID_KEY
import run.galley.cloud.db.generated.keys.WEBAUTHN_CREDENTIALS_PKEY
...
open class WebauthnCredentials(
     ...
     */
    val ID: TableField<WebauthnCredentialsRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")
     ...
     */
    val CREDENTIAL_ID: TableField<WebauthnCredentialsRecord, ByteArray?> = createField(DSL.name("credential_id"), SQLDataType.BLOB.nullable(false), this, "")

    /**
     * The column <code>public.webauthn_credentials.public_key</code>.
     */
    val PUBLIC_KEY: TableField<WebauthnCredentialsRecord, ByteArray?> = createField(DSL.name("public_key"), SQLDataType.BLOB.nullable(false), this, "")
     ...
     */
    val SIGN_COUNT: TableField<WebauthnCredentialsRecord, Long?> = createField(DSL.name("sign_count"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BIGINT)), this, "")

    /**
     * The column <code>public.webauthn_credentials.transports</code>.
     */
    val TRANSPORTS: TableField<WebauthnCredentialsRecord, Array<String?>?> = createField(DSL.name("transports"), SQLDataType.CLOB.array(), this, "")

    /**
     * The column <code>public.webauthn_credentials.is_discoverable</code>.
     */
    val IS_DISCOVERABLE: TableField<WebauthnCredentialsRecord, Boolean?> = createField(DSL.name("is_discoverable"), SQLDataType.BOOLEAN, this, "")

    /**
     * The column <code>public.webauthn_credentials.is_backup_eligible</code>.
     */
    val IS_BACKUP_ELIGIBLE: TableField<WebauthnCredentialsRecord, Boolean?> = createField(DSL.name("is_backup_eligible"), SQLDataType.BOOLEAN, this, "")
     ...
     */
    val LAST_USED_AT: TableField<WebauthnCredentialsRecord, OffsetDateTime?> = createField(DSL.name("last_used_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")

    /**
     * The column <code>public.webauthn_credentials.created_at</code>.
     */
    val CREATED_AT: TableField<WebauthnCredentialsRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    private constructor(alias: Name, aliased: Table<WebauthnCredentialsRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<WebauthnCredentialsRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<WebauthnCredentialsRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, WebauthnCredentialsRecord>?, parentPath: InverseForeignKey<out Record, WebauthnCredentialsRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, WEBAUTHN_CREDENTIALS, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class WebauthnCredentialsPath : WebauthnCredentials, Path<WebauthnCredentialsRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, WebauthnCredentialsRecord>?, parentPath: InverseForeignKey<out Record, WebauthnCredentialsRecord>?): super(path, childPath, parentPath)
     ...
     */
    override fun where(condition: Condition?): WebauthnCredentials = WebauthnCredentials(qualifiedName, if (aliased()) this else null, condition)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): WebauthnCredentials = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): WebauthnCredentials = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): WebauthnCredentials = where(DSL.condition(condition, *parts))
