 ...
 */
@Suppress("warnings")
open class Texticregexeq1 : AbstractRoutine<Boolean>("texticregexeq", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
    ...
    init {
        returnParameter = Texticregexeq1.RETURN_VALUE
        addInParameter(Texticregexeq1._1)
        addInParameter(Texticregexeq1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Texticregexeq1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Texticregexeq1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Texticregexeq1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(Texticregexeq1._2, field)
    }
}
