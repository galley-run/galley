...
open class WebhookDeliveries(
   ...
   */
  val ID: TableField<WebhookDeliveriesRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val SUBSCRIPTION_ID: TableField<WebhookDeliveriesRecord, UUID?> =
    createField(DSL.name("subscription_id"), SQLDataType.UUID.nullable(false), this, "")

  /**
   * The column <code>public.webhook_deliveries.outbox_event_id</code>.
   */
  val OUTBOX_EVENT_ID: TableField<WebhookDeliveriesRecord, UUID?> =
    createField(DSL.name("outbox_event_id"), SQLDataType.UUID.nullable(false), this, "")

  /**
   * The column <code>public.webhook_deliveries.status</code>.
   */
  val STATUS: TableField<WebhookDeliveriesRecord, DeliveryStatus?> =
    createField(
      DSL.name("status"),
      SQLDataType.VARCHAR
        .nullable(
          false,
        ).defaultValue(DSL.field(DSL.raw("'queued'::delivery_status"), SQLDataType.VARCHAR))
        .asEnumDataType(DeliveryStatus::class.java),
      this,
      "",
    )
   ...
   */
  val ATTEMPT_NO: TableField<WebhookDeliveriesRecord, Int?> =
    createField(
      DSL.name("attempt_no"),
   ...
   */
  val RESPONSE_HEADERS: TableField<WebhookDeliveriesRecord, JSONB?> =
    createField(DSL.name("response_headers"), SQLDataType.JSONB, this, "")
   ...
   */
  val CREATED_AT: TableField<WebhookDeliveriesRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, WebhookDeliveriesRecord>?, parentPath: InverseForeignKey<out Record, WebhookDeliveriesRecord>?) : this(
   ...
   */
  open class WebhookDeliveriesPath :
    WebhookDeliveries,
    Path<WebhookDeliveriesRecord> {
    constructor(
      path: Table<out Record>,
      childPath: ForeignKey<out Record, WebhookDeliveriesRecord>?,
      parentPath: InverseForeignKey<out Record, WebhookDeliveriesRecord>?,
  ...
  override fun getIndexes(): List<Index> =
    listOf(
      ...
      IDX_WEBHOOK_DELIVERIES_SUB_TIME,
      IDX_WEBHOOK_DELIVERIES_SUBSCRIPTION,
    )

  override fun getPrimaryKey(): UniqueKey<WebhookDeliveriesRecord> = WEBHOOK_DELIVERIES_PKEY

  override fun getReferences(): List<ForeignKey<WebhookDeliveriesRecord, *>> =
    listOf(WEBHOOK_DELIVERIES__FK_WD_EVENT, WEBHOOK_DELIVERIES__FK_WD_SUBSCRIPTION)
  ...
  val webhookSubscriptions: WebhookSubscriptionsPath by lazy {
    WebhookSubscriptionsPath(
      this,
      WEBHOOK_DELIVERIES__FK_WD_SUBSCRIPTION,
      null,
    )
  }
  ...
  ): WebhookDeliveries = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): WebhookDeliveries = where(DSL.condition(condition, *binds))
  ...
  ): WebhookDeliveries = where(DSL.condition(condition, *parts))
