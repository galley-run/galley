...
import run.galley.cloud.db.generated.indexes.IDX_USER_IDENTITIES_EMAIL_TRGM
import run.galley.cloud.db.generated.indexes.IDX_USER_IDENTITIES_PROVIDER_SUBJECT
import run.galley.cloud.db.generated.indexes.IDX_USER_IDENTITIES_USER_PROVIDER
import run.galley.cloud.db.generated.keys.UQ_USER_IDENTITIES_PROVIDER_SUBJECT
import run.galley.cloud.db.generated.keys.USER_IDENTITIES_PKEY
...
open class UserIdentities(
     ...
     */
    val ID: TableField<UserIdentitiesRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")
     ...
     */
    val CREATED_AT: TableField<UserIdentitiesRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    private constructor(alias: Name, aliased: Table<UserIdentitiesRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<UserIdentitiesRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<UserIdentitiesRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, UserIdentitiesRecord>?, parentPath: InverseForeignKey<out Record, UserIdentitiesRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, USER_IDENTITIES, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class UserIdentitiesPath : UserIdentities, Path<UserIdentitiesRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, UserIdentitiesRecord>?, parentPath: InverseForeignKey<out Record, UserIdentitiesRecord>?): super(path, childPath, parentPath)
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_USER_IDENTITIES_EMAIL, IDX_USER_IDENTITIES_EMAIL_TRGM, IDX_USER_IDENTITIES_PROVIDER_SUBJECT, IDX_USER_IDENTITIES_USER_PROVIDER)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): UserIdentities = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): UserIdentities = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): UserIdentities = where(DSL.condition(condition, *parts))
