 ...
 */
@Suppress("warnings")
open class MvOutboxReadyRecord() : TableRecordImpl<MvOutboxReadyRecord>(MvOutboxReady.MV_OUTBOX_READY) {
  open var id: UUID?
  ...
  /**
   * Create a detached, initialised MvOutboxReadyRecord
   */
  constructor(
    id: UUID? = null,
    vesselId: UUID? = null,
    ...
    attempts: Int? = null,
    nextAttemptAt: OffsetDateTime? = null,
    processedAt: OffsetDateTime? = null,
    error: String? = null,
   ...
   * Create a detached, initialised MvOutboxReadyRecord
   */
  constructor(value: generated.jooq.tables.pojos.MvOutboxReady?) : this() {
    if (value != null) {
      this.id = value.id
