...
import run.galley.cloud.db.generated.indexes.IDX_EMAIL_LOGIN_TOKENS_EMAIL
import run.galley.cloud.db.generated.indexes.IDX_EMAIL_LOGIN_TOKENS_EXPIRES
import run.galley.cloud.db.generated.indexes.IDX_EMAIL_LOGIN_TOKENS_LOOKUP
import run.galley.cloud.db.generated.indexes.IDX_EMAIL_LOGIN_TOKENS_USED
import run.galley.cloud.db.generated.indexes.IDX_EMAIL_LOGIN_TOKENS_USER
import run.galley.cloud.db.generated.keys.EMAIL_LOGIN_TOKENS_PKEY
import run.galley.cloud.db.generated.keys.EMAIL_LOGIN_TOKENS_TOKEN_HASH_KEY
...
open class EmailLoginTokens(
     ...
     */
    val ID: TableField<EmailLoginTokensRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")
     ...
     */
    val TOKEN_HASH: TableField<EmailLoginTokensRecord, ByteArray?> = createField(DSL.name("token_hash"), SQLDataType.BLOB.nullable(false), this, "")
     ...
     */
    val EXPIRES_AT: TableField<EmailLoginTokensRecord, OffsetDateTime?> = createField(DSL.name("expires_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")

    /**
     * The column <code>public.email_login_tokens.used_at</code>.
     */
    val USED_AT: TableField<EmailLoginTokensRecord, OffsetDateTime?> = createField(DSL.name("used_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")

    /**
     * The column <code>public.email_login_tokens.created_at</code>.
     */
    val CREATED_AT: TableField<EmailLoginTokensRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    private constructor(alias: Name, aliased: Table<EmailLoginTokensRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<EmailLoginTokensRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<EmailLoginTokensRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, EmailLoginTokensRecord>?, parentPath: InverseForeignKey<out Record, EmailLoginTokensRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, EMAIL_LOGIN_TOKENS, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class EmailLoginTokensPath : EmailLoginTokens, Path<EmailLoginTokensRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, EmailLoginTokensRecord>?, parentPath: InverseForeignKey<out Record, EmailLoginTokensRecord>?): super(path, childPath, parentPath)
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_EMAIL_LOGIN_TOKENS_ACTIVE, IDX_EMAIL_LOGIN_TOKENS_EMAIL, IDX_EMAIL_LOGIN_TOKENS_EXPIRES, IDX_EMAIL_LOGIN_TOKENS_LOOKUP, IDX_EMAIL_LOGIN_TOKENS_USED, IDX_EMAIL_LOGIN_TOKENS_USER)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): EmailLoginTokens = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): EmailLoginTokens = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): EmailLoginTokens = where(DSL.condition(condition, *parts))
