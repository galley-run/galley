...
open class PgpArmorHeaders(
  ...
  private constructor(alias: Name, aliased: Table<PgpArmorHeadersRecord>?) : this(
    alias,
    null,
    null,
    null,
   ...
   */
  fun call(__1: String?): PgpArmorHeaders =
    PgpArmorHeaders(
      DSL.name("pgp_armor_headers"),
      null,
      arrayOf(
   ...
   * Call this table-valued function
   */
  fun call(__1: Field<String?>): PgpArmorHeaders =
    PgpArmorHeaders(
      DSL.name("pgp_armor_headers"),
      null,
      arrayOf(
