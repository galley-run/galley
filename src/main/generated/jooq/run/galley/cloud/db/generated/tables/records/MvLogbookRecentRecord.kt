 ...
 */
@Suppress("warnings")
open class MvLogbookRecentRecord() : TableRecordImpl<MvLogbookRecentRecord>(MvLogbookRecent.MV_LOGBOOK_RECENT) {
    ...
    /**
     * Create a detached, initialised MvLogbookRecentRecord
     */
     ...
     * Create a detached, initialised MvLogbookRecentRecord
     */
    constructor(value: run.galley.cloud.db.generated.tables.pojos.MvLogbookRecent?): this() {
        if (value != null) {
            this.id = value.id
