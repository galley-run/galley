...
import generated.jooq.indexes.IDX_CHARTERS_DELETED_AT
import generated.jooq.indexes.IDX_CHARTERS_VESSEL
import generated.jooq.indexes.IDX_CHARTERS_VESSEL_CREATED
import generated.jooq.indexes.UQ_CHARTERS_VESSEL_NAME
import generated.jooq.keys.CHARTERS_PKEY
import generated.jooq.keys.CHARTERS__FK_CHARTERS_USER
...
import generated.jooq.keys.PROJECT_DATABASES__FK_DB_CHARTER
...
import generated.jooq.tables.CrewCharterMember.CrewCharterMemberPath
...
open class Charters(
   ...
   */
  val ID: TableField<ChartersRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val CREATED_AT: TableField<ChartersRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
   ...
   */
  val DELETED_AT: TableField<ChartersRecord, OffsetDateTime?> =
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, ChartersRecord>?, parentPath: InverseForeignKey<out Record, ChartersRecord>?) : this(
  ...
  override fun getIndexes(): List<Index> =
    listOf(IDX_CHARTERS_DELETED_AT, IDX_CHARTERS_VESSEL, IDX_CHARTERS_VESSEL_CREATED, UQ_CHARTERS_VESSEL_NAME)
  ...
  ): Charters = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): Charters = where(DSL.condition(condition, *binds))
  ...
  ): Charters = where(DSL.condition(condition, *parts))
