...
open class Logbook(
   ...
   */
  val ID: TableField<LogbookRecord, UUID?> =
    createField(
      DSL.name("id"),
   ...
   */
  val CREATED_AT: TableField<LogbookRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  constructor(path: Table<out Record>, childPath: ForeignKey<out Record, LogbookRecord>?, parentPath: InverseForeignKey<out Record, LogbookRecord>?) : this(
  ...
  override fun getIndexes(): List<Index> =
    listOf(IDX_LOGBOOK_CHARTER_TIME, IDX_LOGBOOK_DETAILS_GIN, IDX_LOGBOOK_OBJECT_TIME, IDX_LOGBOOK_USER_TIME, IDX_LOGBOOK_VESSEL_TIME)

  override fun getPrimaryKey(): UniqueKey<LogbookRecord> = LOGBOOK_PKEY

  override fun getReferences(): List<ForeignKey<LogbookRecord, *>> =
    listOf(LOGBOOK__FK_LOGBOOK_CHARTER, LOGBOOK__FK_LOGBOOK_USER, LOGBOOK__FK_LOGBOOK_VESSEL)
  ...
  ): Logbook = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): Logbook = where(DSL.condition(condition, *binds))
  ...
  ): Logbook = where(DSL.condition(condition, *parts))
