 ...
 */
@Suppress("warnings")
open class RegexpReplace1 : AbstractRoutine<String>("regexp_replace", Public.PUBLIC, DSL.comment(""), SQLDataType.CLOB) {
    companion object {
    ...
    init {
        returnParameter = RegexpReplace1.RETURN_VALUE
        addInParameter(RegexpReplace1._1)
        addInParameter(RegexpReplace1._2)
        addInParameter(RegexpReplace1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(RegexpReplace1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(RegexpReplace1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(RegexpReplace1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(RegexpReplace1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(RegexpReplace1._3, value)
    ...
    fun set__3(field: Field<String?>): Unit {
        setField(RegexpReplace1._3, field)
    }
}
