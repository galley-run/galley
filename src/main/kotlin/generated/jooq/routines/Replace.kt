 ...
 */
@Suppress("warnings")
open class Replace : AbstractRoutine<String>("replace", Public.PUBLIC, DSL.comment(""), SQLDataType.CLOB) {
    companion object {
         ...
         */
        val _3: Parameter<String?> = Internal.createParameter("_3", DefaultDataType.getDefaultDataType("\"public\".\"citext\""), false, true, CitextBinding())
    }
